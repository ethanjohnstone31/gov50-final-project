...
One Interesting Data Visualization:

A scatter plot of Percent Voter Turnout and County Population. Demonstrates that the voter turnout of small counties in 2016 varied significantly, while the most populous counties are closer to the median voter turnout among all counties and did not vary significantly.
...
ggplot(turnout, mapping = aes(x = turnout_perc, y = Population)) +
labs(x = "Percent Voter Turnout",
     y = "Population of County",
     title = "County Population and Voter Turnout") +
  geom_point()
